  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-6 text-center md:text-left relative z-10">
        ...
        >
          <p
            className={`text-xl md:text-2xl font-semibold ${theme === "dark" ? "text-indigo-400" : "text-indigo-600"}`}
          >
           Android Developer | Machine Learning Enthusiast
          </p>
        </motion.div>
        ...
        >
          Passionate Computer Science Engineering student skilled in android development, machine learning, and system-level programming, focused on building scalable and impactful solutions.
        </motion.p>
        ...
        >
          <motion.a
            href="/projects/CvNirajKumar.pdf"
            download
