...
const technicalSkills = [
  {
    title: "Languages",
    items: ["Python", "Java", "C++", "C", "JavaScript", "Kotlin"],
  },
  {
    title: "Web / App",
    items: ["HTML", "CSS", "React", "Flask", "Android Studio"],
  },
  {
    title: "Tools",
    items: ["Git", "GitHub", "MySQL", "NumPy", "Pandas", "Scikit-learn"],
  },
];
      ...
      >
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            >
              Tools, technologies & programming expertise
            </p>
          </div>
        </div>
          ...
          {filteredTechnical.map((group, idx) => (
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(120deg, rgba(79,70,229,0.2), rgba(139,92,246,0.2), rgba(236,72,153,0.2))",
          ...
          {filteredSoft.map((group, idx) => (
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(120deg, rgba(168,85,247,0.2), rgba(168,85,247,0.15), rgba(139,92,246,0.2))",
                  backgroundSize: "200% 200%",
                }}
                animate={{
                  backgroundPosition: ["0% 0%", "100% 100%", "0% 0%"],
