  ...
  return (
    ...
    >
      ...
      >
        ...
        . I enjoy translating business requirements into robust, user-centric
        software solutions while continuously exploring emerging technologies in
        AI and mobile platforms.
      </motion.p>
      ...
      >
        I have hands-on experience in Android development, machine learning, and system-level algorithms, and I am continuously improving my skills to become a well-rounded software engineer.
      </motion.p>

      {/* Stats / Achievements */}
      <div className="mt-12 grid grid-cols-2 md:grid-cols-3 gap-6">
        {[
          { value: "40+", label: "Solved on LeetCode", delay: 0.4 },
          { value: "3★", label: "Python on HackerRank", delay: 0.5 },
          { value: "DSA, OOP, OS", label: "Strong Foundation", delay: 0.6 },
        ].map((stat) => (
          <AnimatedCounter
            key={stat.label}
            value={stat.value}
      ...
      >
        {[
          ...
          >
            ...
            <h3
              className={`font-semibold text-lg mb-2 ${theme === "dark" ? "text-white" : "text-slate-900"}`}
            >
              {insight.title}
            </h3>
            <p
